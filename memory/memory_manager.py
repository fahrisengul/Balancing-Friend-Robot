...
class MemoryManager:
    ...
    # PERSON
    # person_profiles:
    # id, name, role, birth_date, created_at
    # =========================================================
    ...
    def search_memories(self, text, limit=3):
        ...
        Vector search boş dönerse son kayıtları getirir.
        """
        with get_connection() as conn:
            rows = conn.execute(
                """
    ...
    # TEMPLATE
    # intent_templates:
    # id, intent_name, template_text, tone, lang, priority, is_active, created_at
    # =========================================================
    ...
    # LOGS
    # conversation_logs:
    # id, raw_text, normalized_text, intent, response_source, reply_text, created_at
    # =========================================================
    ...
    # id, session_id, intent, response_source, model_name,
    ...
    # llm_calls:
    # id, session_id, intent, model_name, prompt_chars, response_chars,
    ...
    # system_events:
    # id, event_type, detail_text, created_at
    ...
    # conversation_logs -> tutulur
    # episodic_memories -> cleanup ile silinmez
    # =========================================================
    ...
    # daily_metrics:
    # id, metric_date, intent, response_source, total_count,
    # avg_latency_ms, llm_count, error_count
